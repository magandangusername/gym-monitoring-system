...
Public Class progress_report
    Private Sub progress_report_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        txtInitialHeight.Text = getdata("height")
        txtInitialWeight.Text = getdata("weight")
    ...
    Private Sub loadSession()
        ...
        txtRemarks.Text = getdata("sessiondate")
        txtRecommendation.Text = getdata("sessiondate")
    End Sub



    Private Sub dgvSessions_CellClick_1(sender As Object, e As DataGridViewCellEventArgs) Handles dgvSessions.CellClick
